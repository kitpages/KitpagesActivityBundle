<?php
namespace Kitpages\ActivityBundle\Tests;

use Kitpages\ActivityBundle\Tests\SchemaSetupListener;
    ...
    extends OrmTestCase
{
    ...
    protected function createEntityManager()
    {
        ...
        if (is_dir(__DIR__.'/../Resources/config/doctrine')) {
            ...
            $configPathList[] = $dir;
            $prefixList[$dir] = 'Kitpages\ActivityBundle\Entity';
        }
//        if (is_dir(__DIR__.'/_doctrine/config')) {
//            $dir = __DIR__.'/_doctrine/config';
//            $configPathList[] = $dir;
//            $prefixList[$dir] = 'Kolor\MediaLayerBundle\Tests\TestEntities';
//        }
...
//        $driver->setNamespacePrefixes($prefixList);
        ...
        $config->setProxyNamespace('Kitpages\ActivityBundle\Tests\TestProxies');
